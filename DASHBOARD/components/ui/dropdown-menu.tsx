  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[8rem] rounded-lg border bg-popover p-1 shadow-lg backdrop-blur-sm",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      checked={checked}
      className={cn(
        "relative flex select-none items-center gap-2 rounded-md py-1.5 pr-2 pl-8 text-sm outline-none",
        "cursor-default transition-colors",
        "focus:bg-accent focus:text-accent-foreground",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("my-1 h-px bg-border/40 -mx-1", className)}
      {...props}
    />
  )
}
