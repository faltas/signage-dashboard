...
import { Monitor, Plus, ChevronLeft, QrCode, Globe, Cpu, Scan } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <Button 
                        ...
                        variant="ghost" 
                        size="sm" 
                        className="text-primary gap-2 h-auto py-1 px-2"
              ...
              <div className="space-y-6">
                 <Card className="glass-premium p-6 md:p-8 border-none space-y-6">
                    ...
                    <div className="space-y-4">
                      <div 
                        className="flex items-start gap-4 p-4 bg-white/5 rounded-2xl cursor-pointer hover:bg-white/10 transition-colors"
                        onClick={() => setIsScannerOpen(true)}
                      >
